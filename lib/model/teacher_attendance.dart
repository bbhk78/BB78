...
class TeacherAttendanceDay {
  ...
  Map<String, dynamic> toFirestore() =>
      <String, dynamic>{'date': date, 'status': status.name};
...
class TeacherAttendanceCalendar {
  ...
  List<dynamic> toFirestore() =>
      calendar.map((TeacherAttendanceDay day) => day.toFirestore()).toList();

  TeacherAttendanceCalendar.fromFirestoreData(List<dynamic> data) {
    calendar = data
        .map<TeacherAttendanceDay>((dynamic day) =>
            TeacherAttendanceDay.fromFirestoreData(day as Map<String, dynamic>))
        .toList();
  }
}
