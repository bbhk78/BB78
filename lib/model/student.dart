...
class Student extends Equatable {
  ...
  double get attendancePercent {
    ...
    final int countedDays = attendance.calendar
        .where((StudentAttendanceDay day) =>
            ...
            day.status == StudentAttendance.nn)
        .length;
  ...
  StudentAttendanceDay? get todayAttendance {
    final List<StudentAttendanceDay> validDays = attendance.calendar
        .where((StudentAttendanceDay day) => day.date.toDate().isToday())
        .toList();
