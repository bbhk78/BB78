...
class Teacher extends Equatable {
  ...
  double get attendancePercent {
    ...
    final int countedDays = attendance.calendar
        .where((TeacherAttendanceDay day) =>
            TeacherAttendanceExt.isPresent(day.status))
        .length;
  ...
  TeacherAttendanceDay? get todayAttendance {
    final List<TeacherAttendanceDay> validDays = attendance.calendar
        .where((TeacherAttendanceDay day) => day.date.toDate().isToday())
        .toList();
