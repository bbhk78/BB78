...
class SubGroupsView extends GetWidget<UserController> {
  ...
  const SubGroupsView({Key? key, required this.group}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final List<SubGroup> filteredSubGroups = controller.subgroups
              ...
              itemBuilder: (BuildContext context, int index) {
                ...
                final int numStudents = controller.students
                    .where((Student student) =>
                        student.subgroupId == currSubGroup.id)
                    .length;
...
class SubGroupCardWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) => InkWell(
        ...
        onTap: () => Get.to<void>(() => SubGroupPerformance(
            group: group, subgroup: subgroup, tileColor: tileColor)),
      );
}
