...
class AddTeacherAttendance extends GetWidget<AuthController> {
  ...
  Widget build(BuildContext context) {
    ...
    final Map<Teacher, TeacherAttendanceDay> todayRollcall =
        Map<Teacher, TeacherAttendanceDay>.fromEntries(groupsCtrl.teachers.map(
    ...
    final int numTeachersRecorded = todayRollcall.values
        .where((TeacherAttendanceDay day) =>
            ...
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int groupIndex) {
                ...
                final TeacherAttendanceDay currDay = todayRollcall.entries
                    .firstWhere(
                        (MapEntry<Teacher, TeacherAttendanceDay> entry) =>
                            entry.key.id == currTeacher.id)
                    .value;
                ...
                final TeacherAttendanceDay? potentialDay =
                  ...
                  Wrap(children: <Widget>[
                    TeacherAttendanceRecord(
                        group: group, teacher: teacher, day: day.value)
                  ]),
