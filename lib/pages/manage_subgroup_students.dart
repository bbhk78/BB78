...
class ManageSubGroupStudents extends GetWidget<UserController> {
  ...
  Widget build(BuildContext context) {
    students.value = controller.students.where(
      (Student student) => student.subgroupId == subgroup.id
    ).toList()
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  IconButton(
                    ...
                    onPressed: () async {
                      final TextEditingController addStudentTextCtrl = TextEditingController.fromValue(TextEditingValue.empty);
                      ...
                      await Get.defaultDialog<void>(
                        ...
                        onConfirm: () async {
                          final String newStudentName = addStudentTextCtrl.value.text;
                          Get.back<void>();

                          await Get.dialog<void>(
                            FutureProgressDialog(
                              (() async {
                                final Student? possibleStudent = await controller.addStudent(
                          ...
                          await Get.defaultDialog<void>(
                            ...
                            onConfirm: () async {
                              ...
                              await Get.dialog<void>(
                                FutureProgressDialog(
                                  (() async {
                                    await controller.removeStudent(currStudent);
