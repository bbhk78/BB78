...
class GuiUtils {
  ...
  static Widget loaderDialogContent([String loaderText = 'Loading...']) => AlertDialog(
...
class TypeUtils {
  static List<T> parseList<T>(dynamic possibleList) => (possibleList as List<dynamic>).cast<T>();
  static Map<K, V> parseMap<K, V>(dynamic possibleMap) => (possibleMap as Map<dynamic, dynamic>).cast<K, V>();
  static HashMap<K, V> parseHashMap<K, V>(dynamic possibleMap) => HashMap<K, V>.from(TypeUtils.parseMap<K, V>(possibleMap));
}
